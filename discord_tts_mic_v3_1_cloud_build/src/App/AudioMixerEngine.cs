...
/// <summary>
/// Captures the physical microphone, mixes it with TTS, and streams 48 kHz mono PCM16
/// to the in-product virtual microphone driver.
/// </summary>
public sealed class AudioMixerEngine : IDisposable
{
    ...
    {
        // NAudio/WASAPI physical mic formats vary. Convert each chunk to 48k mono PCM16.
